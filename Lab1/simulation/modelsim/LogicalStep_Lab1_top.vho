...
SIGNAL \inst14|OUT_4~combout\ : std_logic;
SIGNAL \inst14|OUT_3~combout\ : std_logic;
SIGNAL \inst14|OUT_2~combout\ : std_logic;
SIGNAL \inst5|auto_generated|counter_reg_bit\ : std_logic_vector(27 DOWNTO 0);
SIGNAL \inst14|ALT_INV_OUT_2~combout\ : std_logic;
...
\inst14|ALT_INV_OUT_2~combout\ <= NOT \inst14|OUT_2~combout\;
...
-- pragma translate_on
PORT MAP (
	i => \inst14|ALT_INV_OUT_2~combout\,
	devoe => ww_devoe,
	o => \leds[5]~output_o\);
...
-- Equation(s):
-- \inst10~combout\ = (\inst5|auto_generated|counter_reg_bit\(27)) # (!\PB[1]~input_o\)
...
\inst14|OUT_4\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \inst14|OUT_4~combout\ = \inst10~combout\ $ (\sw[1]~input_o\ $ (((\inst5|auto_generated|counter_reg_bit\(26)) # (!\PB[0]~input_o\))))
...
PORT MAP (
	...
	combout => \inst14|OUT_4~combout\);

-- Location: LCCOMB_X16_Y7_N0
\inst14|OUT_3\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \inst14|OUT_3~combout\ = \sw[1]~input_o\ $ (((\inst10~combout\) # ((\inst5|auto_generated|counter_reg_bit\(26)) # (!\PB[0]~input_o\))))
...
PORT MAP (
	...
	datac => \PB[0]~input_o\,
	datad => \inst5|auto_generated|counter_reg_bit\(26),
	combout => \inst14|OUT_3~combout\);

-- Location: LCCOMB_X16_Y7_N18
\inst14|OUT_2\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \inst14|OUT_2~combout\ = \sw[1]~input_o\ $ (((\inst10~combout\ & ((\inst5|auto_generated|counter_reg_bit\(26)) # (!\PB[0]~input_o\)))))
