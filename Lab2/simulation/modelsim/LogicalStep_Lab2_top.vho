...
SIGNAL \INST4|dout[5]~0_combout\ : std_logic;
SIGNAL \INST5|Add0~10\ : std_logic;
SIGNAL \INST5|Add0~12_combout\ : std_logic;
SIGNAL \INST5|Add0~14_combout\ : std_logic;
SIGNAL \INST4|dout[6]~1_combout\ : std_logic;
SIGNAL \INST4|dout[7]~2_combout\ : std_logic;
...
-- Equation(s):
-- \INST5|Add0~0_combout\ = (\sw[0]~input_o\ & (\sw[4]~input_o\ $ (VCC))) # (!\sw[0]~input_o\ & (\sw[4]~input_o\ & VCC))
-- \INST5|Add0~1\ = CARRY((\sw[0]~input_o\ & \sw[4]~input_o\))
...
-- Equation(s):
-- \INST5|Add0~2_combout\ = (\pb[3]~input_o\ & (\sw[0]~input_o\)) # (!\pb[3]~input_o\ & ((\INST5|Add0~0_combout\)))
...
-- Equation(s):
-- \INST5|Add0~3_combout\ = (\sw[5]~input_o\ & ((\sw[1]~input_o\ & (\INST5|Add0~1\ & VCC)) # (!\sw[1]~input_o\ & (!\INST5|Add0~1\)))) # (!\sw[5]~input_o\ & ((\sw[1]~input_o\ & (!\INST5|Add0~1\)) # (!\sw[1]~input_o\ & ((\INST5|Add0~1\) # (GND)))))
-- \INST5|Add0~4\ = CARRY((\sw[5]~input_o\ & (!\sw[1]~input_o\ & !\INST5|Add0~1\)) # (!\sw[5]~input_o\ & ((!\INST5|Add0~1\) # (!\sw[1]~input_o\))))
...
-- Equation(s):
-- \INST5|Add0~6_combout\ = ((\sw[6]~input_o\ $ (\sw[2]~input_o\ $ (!\INST5|Add0~4\)))) # (GND)
-- \INST5|Add0~7\ = CARRY((\sw[6]~input_o\ & ((\sw[2]~input_o\) # (!\INST5|Add0~4\))) # (!\sw[6]~input_o\ & (\sw[2]~input_o\ & !\INST5|Add0~4\)))
...
-- Equation(s):
-- \INST5|Add0~8_combout\ = (\pb[3]~input_o\ & ((\sw[2]~input_o\))) # (!\pb[3]~input_o\ & (\INST5|Add0~6_combout\))
...
-- Equation(s):
-- \INST5|Add0~5_combout\ = (\pb[3]~input_o\ & ((\sw[1]~input_o\))) # (!\pb[3]~input_o\ & (\INST5|Add0~3_combout\))
...
-- Equation(s):
-- \INST5|Add0~9_combout\ = (\sw[7]~input_o\ & ((\sw[3]~input_o\ & (\INST5|Add0~7\ & VCC)) # (!\sw[3]~input_o\ & (!\INST5|Add0~7\)))) # (!\sw[7]~input_o\ & ((\sw[3]~input_o\ & (!\INST5|Add0~7\)) # (!\sw[3]~input_o\ & ((\INST5|Add0~7\) # (GND)))))
-- \INST5|Add0~10\ = CARRY((\sw[7]~input_o\ & (!\sw[3]~input_o\ & !\INST5|Add0~7\)) # (!\sw[7]~input_o\ & ((!\INST5|Add0~7\) # (!\sw[3]~input_o\))))
...
-- Equation(s):
-- \INST5|Add0~11_combout\ = (\pb[3]~input_o\ & ((\sw[3]~input_o\))) # (!\pb[3]~input_o\ & (\INST5|Add0~9_combout\))
...
-- Equation(s):
-- \INST1|Mux5~0_combout\ = (\INST5|Add0~5_combout\ & ((\INST5|Add0~2_combout\ & ((\INST5|Add0~11_combout\))) # (!\INST5|Add0~2_combout\ & (\INST5|Add0~8_combout\)))) # (!\INST5|Add0~5_combout\ & (\INST5|Add0~8_combout\ & (\INST5|Add0~2_combout\ $ 
-- (\INST5|Add0~11_combout\))))
...
PORT MAP (
	...
	datad => \INST5|Add0~11_combout\,
	combout => \INST1|Mux5~0_combout\);

-- Location: LCCOMB_X10_Y9_N6
\INST4|dout[5]~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \INST4|dout[5]~0_combout\ = (\sw[5]~input_o\ & \pb[3]~input_o\)
...
PORT MAP (
	datac => \sw[5]~input_o\,
	datad => \pb[3]~input_o\,
	combout => \INST4|dout[5]~0_combout\);

-- Location: LCCOMB_X10_Y9_N22
\INST5|Add0~12\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \INST5|Add0~12_combout\ = !\INST5|Add0~10\
...
-- Equation(s):
-- \INST5|Add0~14_combout\ = (\pb[3]~input_o\ & (\sw[4]~input_o\)) # (!\pb[3]~input_o\ & ((\INST5|Add0~12_combout\)))
...
\INST4|dout[6]~1\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \INST4|dout[6]~1_combout\ = (\sw[6]~input_o\ & \pb[3]~input_o\)
...
PORT MAP (
	datac => \sw[6]~input_o\,
	datad => \pb[3]~input_o\,
	combout => \INST4|dout[6]~1_combout\);

-- Location: LCCOMB_X10_Y9_N28
\INST4|dout[7]~2\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \INST4|dout[7]~2_combout\ = (\sw[7]~input_o\ & \pb[3]~input_o\)
...
PORT MAP (
	datac => \sw[7]~input_o\,
	datad => \pb[3]~input_o\,
	combout => \INST4|dout[7]~2_combout\);

-- Location: LCCOMB_X10_Y9_N26
\INST2|Mux5~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \INST2|Mux5~0_combout\ = (\INST4|dout[5]~0_combout\ & ((\INST5|Add0~14_combout\ & ((\INST4|dout[7]~2_combout\))) # (!\INST5|Add0~14_combout\ & (\INST4|dout[6]~1_combout\)))) # (!\INST4|dout[5]~0_combout\ & (\INST4|dout[6]~1_combout\ & 
-- (\INST5|Add0~14_combout\ $ (\INST4|dout[7]~2_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \INST4|dout[5]~0_combout\,
	datab => \INST5|Add0~14_combout\,
	datac => \INST4|dout[6]~1_combout\,
	datad => \INST4|dout[7]~2_combout\,
...
-- Equation(s):
-- \INST2|Mux1~0_combout\ = (\INST4|dout[6]~1_combout\ & ((\INST4|dout[7]~2_combout\ & (!\INST4|dout[5]~0_combout\)) # (!\INST4|dout[7]~2_combout\ & (\INST4|dout[5]~0_combout\ & \INST5|Add0~14_combout\)))) # (!\INST4|dout[6]~1_combout\ & 
-- (!\INST4|dout[7]~2_combout\ & ((\INST4|dout[5]~0_combout\) # (\INST5|Add0~14_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \INST4|dout[6]~1_combout\,
	datab => \INST4|dout[7]~2_combout\,
	datac => \INST4|dout[5]~0_combout\,
...
-- Equation(s):
-- \INST1|Mux1~0_combout\ = (\INST5|Add0~11_combout\ & (((\INST5|Add0~8_combout\ & !\INST5|Add0~5_combout\)))) # (!\INST5|Add0~11_combout\ & ((\INST5|Add0~2_combout\ & ((\INST5|Add0~5_combout\) # (!\INST5|Add0~8_combout\))) # (!\INST5|Add0~2_combout\ & 
-- (!\INST5|Add0~8_combout\ & \INST5|Add0~5_combout\))))
...
-- Equation(s):
-- \INST2|Mux0~0_combout\ = (\INST4|dout[7]~2_combout\) # ((\INST4|dout[6]~1_combout\ & ((!\INST5|Add0~14_combout\) # (!\INST4|dout[5]~0_combout\))) # (!\INST4|dout[6]~1_combout\ & (\INST4|dout[5]~0_combout\)))
...
-- Equation(s):
-- \INST1|Mux0~0_combout\ = (\INST5|Add0~11_combout\) # ((\INST5|Add0~8_combout\ & ((!\INST5|Add0~5_combout\) # (!\INST5|Add0~2_combout\))) # (!\INST5|Add0~8_combout\ & ((\INST5|Add0~5_combout\))))
...
-- Equation(s):
-- \INST2|Mux6~0_combout\ = (\INST4|dout[6]~1_combout\ & (!\INST4|dout[5]~0_combout\ & ((\INST4|dout[7]~2_combout\) # (!\INST5|Add0~14_combout\)))) # (!\INST4|dout[6]~1_combout\ & (\INST5|Add0~14_combout\ & (\INST4|dout[7]~2_combout\ $ 
-- (!\INST4|dout[5]~0_combout\))))
...
-- Equation(s):
-- \INST1|Mux6~0_combout\ = (\INST5|Add0~8_combout\ & (!\INST5|Add0~5_combout\ & ((\INST5|Add0~11_combout\) # (!\INST5|Add0~2_combout\)))) # (!\INST5|Add0~8_combout\ & (\INST5|Add0~2_combout\ & (\INST5|Add0~11_combout\ $ (!\INST5|Add0~5_combout\))))
...
-- Equation(s):
-- \INST1|Mux4~0_combout\ = (\INST5|Add0~11_combout\ & (\INST5|Add0~8_combout\ & ((\INST5|Add0~5_combout\) # (!\INST5|Add0~2_combout\)))) # (!\INST5|Add0~11_combout\ & (!\INST5|Add0~2_combout\ & (!\INST5|Add0~8_combout\ & \INST5|Add0~5_combout\)))
...
-- Equation(s):
-- \INST2|Mux4~0_combout\ = (\INST4|dout[6]~1_combout\ & (\INST4|dout[7]~2_combout\ & ((\INST4|dout[5]~0_combout\) # (!\INST5|Add0~14_combout\)))) # (!\INST4|dout[6]~1_combout\ & (!\INST4|dout[7]~2_combout\ & (\INST4|dout[5]~0_combout\ & 
...
-- Equation(s):
-- \INST2|Mux3~0_combout\ = (\INST4|dout[5]~0_combout\ & ((\INST5|Add0~14_combout\ & (\INST4|dout[6]~1_combout\)) # (!\INST5|Add0~14_combout\ & (!\INST4|dout[6]~1_combout\ & \INST4|dout[7]~2_combout\)))) # (!\INST4|dout[5]~0_combout\ & 
-- (!\INST4|dout[7]~2_combout\ & (\INST5|Add0~14_combout\ $ (\INST4|dout[6]~1_combout\))))
...
-- Equation(s):
-- \INST1|Mux3~0_combout\ = (\INST5|Add0~5_combout\ & ((\INST5|Add0~2_combout\ & ((\INST5|Add0~8_combout\))) # (!\INST5|Add0~2_combout\ & (\INST5|Add0~11_combout\ & !\INST5|Add0~8_combout\)))) # (!\INST5|Add0~5_combout\ & (!\INST5|Add0~11_combout\ & 
-- (\INST5|Add0~2_combout\ $ (\INST5|Add0~8_combout\))))
...
-- Equation(s):
-- \INST2|Mux2~0_combout\ = (\INST4|dout[5]~0_combout\ & (((!\INST4|dout[7]~2_combout\ & \INST5|Add0~14_combout\)))) # (!\INST4|dout[5]~0_combout\ & ((\INST4|dout[6]~1_combout\ & (!\INST4|dout[7]~2_combout\)) # (!\INST4|dout[6]~1_combout\ & 
-- ((\INST5|Add0~14_combout\)))))
...
-- Equation(s):
-- \INST1|Mux2~0_combout\ = (\INST5|Add0~5_combout\ & (\INST5|Add0~2_combout\ & (!\INST5|Add0~11_combout\))) # (!\INST5|Add0~5_combout\ & ((\INST5|Add0~8_combout\ & ((!\INST5|Add0~11_combout\))) # (!\INST5|Add0~8_combout\ & (\INST5|Add0~2_combout\))))
