...
SIGNAL \shift_register|current_state~1_combout\ : std_logic;
SIGNAL \shift_register|current_state~2_combout\ : std_logic;
SIGNAL \shift_register|current_state~3_combout\ : std_logic;
SIGNAL \shift_register|current_state~0_combout\ : std_logic;
...
SIGNAL \shift_register|current_state\ : std_logic_vector(3 DOWNTO 0);
SIGNAL \output|ALT_INV_DOUT[4]~4_combout\ : std_logic;
SIGNAL \output|ALT_INV_DOUT[3]~3_combout\ : std_logic;
SIGNAL \shift_register|ALT_INV_current_state\ : std_logic_vector(0 DOWNTO 0);
...
\shift_register|ALT_INV_current_state\(0) <= NOT \shift_register|current_state\(0);
...
-- pragma translate_on
PORT MAP (
	i => \shift_register|ALT_INV_current_state\(0),
	devoe => ww_devoe,
	o => \leds[4]~output_o\);
...
-- pragma translate_on
PORT MAP (
	i => \shift_register|current_state\(1),
	devoe => ww_devoe,
	o => \leds[5]~output_o\);
...
-- pragma translate_on
PORT MAP (
	i => \shift_register|current_state\(2),
	devoe => ww_devoe,
	o => \leds[6]~output_o\);
...
-- pragma translate_on
PORT MAP (
	i => \shift_register|current_state\(3),
	devoe => ww_devoe,
	o => \leds[7]~output_o\);
...
\shift_register|current_state~1\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \shift_register|current_state~1_combout\ = (\pb[0]~input_o\ & ((!\shift_register|current_state\(0)))) # (!\pb[0]~input_o\ & (\shift_register|current_state\(2)))
...
PORT MAP (
	dataa => \pb[0]~input_o\,
	datac => \shift_register|current_state\(2),
	datad => \shift_register|current_state\(0),
	combout => \shift_register|current_state~1_combout\);

-- Location: FF_X12_Y11_N1
\shift_register|current_state[1]\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
PORT MAP (
	clk => \bin_counter[23]~clkctrl_outclk\,
	d => \shift_register|current_state~1_combout\,
	clrn => \rst_n~input_o\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \shift_register|current_state\(1));

-- Location: LCCOMB_X12_Y11_N22
\shift_register|current_state~2\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \shift_register|current_state~2_combout\ = (\pb[0]~input_o\ & (\shift_register|current_state\(1))) # (!\pb[0]~input_o\ & ((\shift_register|current_state\(3))))
...
PORT MAP (
	dataa => \pb[0]~input_o\,
	datac => \shift_register|current_state\(1),
	datad => \shift_register|current_state\(3),
	combout => \shift_register|current_state~2_combout\);

-- Location: FF_X12_Y11_N23
\shift_register|current_state[2]\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
PORT MAP (
	clk => \bin_counter[23]~clkctrl_outclk\,
	d => \shift_register|current_state~2_combout\,
	clrn => \rst_n~input_o\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \shift_register|current_state\(2));

-- Location: LCCOMB_X12_Y11_N20
\shift_register|current_state~3\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \shift_register|current_state~3_combout\ = (\pb[0]~input_o\ & (\shift_register|current_state\(2))) # (!\pb[0]~input_o\ & ((!\shift_register|current_state\(0))))
...
PORT MAP (
	...
	datac => \shift_register|current_state\(2),
	datad => \shift_register|current_state\(0),
	combout => \shift_register|current_state~3_combout\);

-- Location: FF_X12_Y11_N21
\shift_register|current_state[3]\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
PORT MAP (
	clk => \bin_counter[23]~clkctrl_outclk\,
	d => \shift_register|current_state~3_combout\,
	clrn => \rst_n~input_o\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \shift_register|current_state\(3));

-- Location: LCCOMB_X12_Y11_N6
\shift_register|current_state~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \shift_register|current_state~0_combout\ = (\pb[0]~input_o\ & (!\shift_register|current_state\(3))) # (!\pb[0]~input_o\ & ((!\shift_register|current_state\(1))))
...
PORT MAP (
	dataa => \pb[0]~input_o\,
	datab => \shift_register|current_state\(3),
	datad => \shift_register|current_state\(1),
	combout => \shift_register|current_state~0_combout\);

-- Location: FF_X12_Y11_N7
\shift_register|current_state[0]\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
PORT MAP (
	clk => \bin_counter[23]~clkctrl_outclk\,
	d => \shift_register|current_state~0_combout\,
	clrn => \rst_n~input_o\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \shift_register|current_state\(0));
