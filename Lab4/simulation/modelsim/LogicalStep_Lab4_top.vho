...
SIGNAL \reg|bit1|q~1_combout\ : std_logic;
SIGNAL \pb[3]~input_o\ : std_logic;
SIGNAL \pb[2]~input_o\ : std_logic;
SIGNAL \reg|bit1|q~0_combout\ : std_logic;
SIGNAL \reg|bit1|q~q\ : std_logic;
SIGNAL \reg|bit2|q~feeder_combout\ : std_logic;
SIGNAL \reg|bit2|q~q\ : std_logic;
SIGNAL \reg|bit3|q~q\ : std_logic;
SIGNAL \pb[1]~input_o\ : std_logic;
SIGNAL \reg|bit4|q~0_combout\ : std_logic;
SIGNAL \reg|bit4|q~1_combout\ : std_logic;
SIGNAL \reg|bit4|q~q\ : std_logic;
...
\reg|bit1|q~1\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \reg|bit1|q~1_combout\ = !\pb[0]~input_o\
...
\reg|bit1|q~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \reg|bit1|q~0_combout\ = (\pb[3]~input_o\ & !\pb[2]~input_o\)
...
PORT MAP (
	...
	d => \reg|bit1|q~1_combout\,
	ena => \reg|bit1|q~0_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \reg|bit1|q~q\);

-- Location: LCCOMB_X9_Y4_N22
\reg|bit2|q~feeder\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \reg|bit2|q~feeder_combout\ = \reg|bit1|q~q\
...
PORT MAP (
	datad => \reg|bit1|q~q\,
	combout => \reg|bit2|q~feeder_combout\);
...
\reg|bit4|q~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \reg|bit4|q~0_combout\ = (!\pb[2]~input_o\ & ((\pb[3]~input_o\ & ((\reg|bit3|q~q\))) # (!\pb[3]~input_o\ & (!\pb[1]~input_o\))))
...
PORT MAP (
	...
	datac => \pb[3]~input_o\,
	datad => \reg|bit3|q~q\,
	combout => \reg|bit4|q~0_combout\);

-- Location: LCCOMB_X9_Y4_N30
\reg|bit4|q~1\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \reg|bit4|q~1_combout\ = (\reg|bit4|q~0_combout\) # ((\pb[2]~input_o\ & \reg|bit4|q~q\))
...
PORT MAP (
	datab => \pb[2]~input_o\,
	datac => \reg|bit4|q~q\,
	datad => \reg|bit4|q~0_combout\,
	combout => \reg|bit4|q~1_combout\);
